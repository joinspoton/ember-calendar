...
Ember.Calendar.HeadingDatesView=Ember.ContainerView.extend({classNames:["ember-calendar-head-dates"],updateChildViews:function(){var a=this;this.removeAllChildren();$("#"+this.get("elementId")).html("");this.get("childViews").pushObjects(this.get("dates").map(function(b){return Ember.get(a.get("parentView.controller.headingDateViewClass")).create({date:b})}))}.observes("dates"),init:function(){this._super();this.updateChildViews()}});
...
Ember.Calendar.HeadingTimesView=Ember.ContainerView.extend({classNames:["ember-calendar-head-times"],updateChildViews:function(){var a=this;this.removeAllChildren();$("#"+this.get("elementId")).html("");this.get("childViews").pushObjects(this.get("times").map(function(b){return Ember.get(a.get("parentView.controller.headingTimeViewClass")).create({time:b})}))}.observes("times"),init:function(){this._super();this.updateChildViews()}});
...
Ember.Calendar.DaysView=Ember.ContainerView.extend({classNames:["ember-calendar-days"],updateChildViews:function(){var a=this;this.removeAllChildren();$("#"+this.get("elementId")).html("");this.get("childViews").pushObjects(this.get("days").map(function(b){return Ember.get(a.get("parentView.controller.dayViewClass")).create({events:b,parentView:a.get("parentView")})}))}.observes("days"),init:function(){this._super();this.updateChildViews()}});
Ember.Calendar.DayView=Ember.ContainerView.extend({classNames:["ember-calendar-day"],updateChildViews:function(){var a=this;this.removeAllChildren();$("#"+this.get("elementId")).html("");this.get("childViews").pushObjects(this.get("events").map(function(b){return Ember.get(a.get("parentView.controller.eventViewClass")).create({event:b,parentView:a.get("parentView")})}))}.observes("events"),init:function(){this._super();this.updateChildViews()}});
